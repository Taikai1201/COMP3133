...
mongoose.connect("mongodb+srv://vudangdaiduong:Taikai1201@assignment1.ij06984.mongodb.net/lab3?retryWrites=true&w=majority", {
...
async function insertSeed(){
    try{
        const response = await Restaurant.insertMany(seedData);
        console.log("New data has been added to DB successfully")
    }catch (err){
