...
mongoose.connect("mongodb+srv://vudangdaiduong:Taikai1201@assignment1.ij06984.mongodb.net/Users?retryWrites=true&w=majority", {
...
async function insertSeed(){
    try{
        const response = await User.insertMany(seedData);
